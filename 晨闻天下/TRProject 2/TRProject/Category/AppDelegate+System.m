...
- (void)setupGlobalConfig{
    [UINavigationBar appearance ].barTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"背景"]];
    [UINavigationBar appearance].tintColor = [UIColor whiteColor];
    [UITabBar appearance].barTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"背景"]];
